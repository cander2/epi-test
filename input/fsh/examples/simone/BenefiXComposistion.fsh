...
* section[=].section[+] //When you see it like this (x2 sections) it means this is a level 2 heading under the previous section. E.g., 1.1
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>
          <p>Animal reproduction studies have not been conducted with factor IX. Based on the rare occurrence of haemophilia B in women, experience regarding the use of factor IX during pregnancy and breastfeeding is not available. Therefore, factor IX should be used during pregnancy and breast<wbr>feeding only if clearly indicated.</p>
