...
Instance: ZithromaxPOSMedicinalProductAR
InstanceOf: MedicinalProductDefinitionUvEpi
Title: "Medicinal Product zithromax (azithromycin) POS"
Description: "zithromax (azithromycin) 200 mg/5 ml powder for oral suspension -أزيثرومايسين مسحوق 200 مغ/5 مل لتحضير معلق للاستعمال عبر الفم "
Usage: #example
