...
* identifier.value = "514a4a6a&hyphen;76e4&hyphen;11ee&hyphen;b962&hyphen;0242ac120002" //Generate a new UUID from here: https://www.uuidgenerator.net/.
...
<p>IBRANCE is indicated for the treatment of hormone receptor (HR)&hyphen;positive, human epidermal growth factor receptor 2 (HER2)&hyphen;negative locally advanced or metastatic breast cancer in combination with:</p>
<ul>
...
<p>In pre&hyphen; or perimenopausal women, the endocrine therapy should be combined with a luteinizing hormone&hyphen;releasing hormone (LHRH) agonist.</p>
    ...
    <tfoot>
        <tr>
            <td colspan="2">
                ...
                <p><sup>b</sup>&nbsp; Absolute neutrophil count (ANC): Grade 1: ANC &lt;LLN &hyphen; 1500/mm<sup>3</sup>; Grade 2: ANC 1000 &hyphen; &lt;1500/mm<sup>3</sup>; Grade 3: ANC 500 &hyphen; &lt;1000/mm<sup>3</sup>; Grade 4: ANC &lt;500/mm<sup>3</sup></p>
            </td>
        </tr>
    </tfoot>
    <tbody>
...
<table border="1">
    <thead>
         <tr>
            <td colspan="2" align="center">
                <p><b>Table 3.	Dose Modification and Management – Non&hyphen;Hematologic Toxicities</b></p>
            </td>
        </tr>
    </thead>
    <tfoot>
    ...
    <tbody>
         ...
         <tr>
          <td>Grade &ge;3 non&hyphen;hematologic toxicity (if persisting despite optimal medical treatment)</td>
          <td>
...
<p>Refer to the full prescribing information for co&hyphen;administered endocrine therapy dose adjustment guidelines in the event of toxicity and other relevant safety information or contraindications.</p>
<p><b>Dose Modifications for Use with Strong CYP3A Inhibitors</b></p>
<p>Avoid concomitant use of strong CYP3A inhibitors and consider an alternative concomitant medication with no or minimal CYP3A inhibition. If patients must be co&hyphen;administered a strong CYP3A inhibitor, reduce the IBRANCE dose to 75 mg once daily. If the strong inhibitor is discontinued, increase the IBRANCE dose (after 3 to 5 half&hyphen;lives of the inhibitor) to the dose used prior to the initiation of the strong CYP3A inhibitor [<i>see Drug Interactions (7.1) and Clinical Pharmacology (11.3)</i>].</p>
<p><b>Dose Modifications for Hepatic Impairment</b></p>
<p>No dose adjustment is required for patients with mild or moderate hepatic impairment (Child&hyphen;Pugh classes A and B). For patients with severe hepatic impairment (Child&hyphen;Pugh class C), the recommended dose of IBRANCE is 75 mg once daily for 21 consecutive days followed by 7 days off treatment to comprise a complete cycle of 28 days [<i>see Use in Specific Populations (8.6) and Clinical Pharmacology (11.3)</i>].</p>
...
<p>Severe, life&hyphen;threatening, or fatal interstitial lung disease (ILD) and/or pneumonitis can occur in patients treated with cyclin&hyphen;dependent kinase 4/6 (CDK4/6) inhibitors, including IBRANCE when taken in combination with endocrine therapy.</p>
<p>Across clinical trials (PALOMA&hyphen;1, PALOMA&hyphen;2, PALOMA&hyphen;3), 1.0% of IBRANCE&hyphen;treated patients had ILD/pneumonitis of any grade, 0.1% had Grade 3 or 4 and no fatal cases were reported. Additional cases of ILD/pneumonitis have been observed in the post&hyphen;marketing setting, with fatalities reported [<i>see Adverse Reactions (6.2)</i>].</p>
...
<p>The following adverse reactions have been identified during post&hyphen;approval use of IBRANCE. Because these reactions are reported voluntarily from a population of uncertain size, it is not always possible to reliably estimate their frequency or establish a causal relationship to drug exposure.</p>
<p><i>Respiratory disorders:</i> Interstitial lung disease (ILD)/non&hyphen;infectious pneumonitis.</p>
...
<p>Co&hyphen;administration of a strong CYP3A inhibitor (itraconazole) increased the plasma exposure of palbociclib in healthy subjects by 87%. Avoid concomitant use of strong CYP3A inhibitors (e.g., clarithromycin, indinavir, itraconazole, ketoconazole, lopinavir/ritonavir, nefazodone, nelfinavir, posaconazole, ritonavir, saquinavir, telaprevir, telithromycin, and voriconazole). Avoid grapefruit or grapefruit juice during IBRANCE treatment. If co&hyphen;administration of IBRANCE with a strong CYP3A inhibitor cannot be avoided, reduce the dose of IBRANCE [<i>see Dosage and Administration (2.2) and Clinical Pharmacology (11.3)</i>].</p>
...
<p>Co&hyphen;administration of a strong CYP3A inducer (rifampin) decreased the plasma exposure of palbociclib in healthy subjects by 85%. Avoid concomitant use of strong CYP3A inducers (e.g., phenytoin, rifampin, carbamazepine, enzalutamide, and St. John’s Wort) [<i>see Clinical Pharmacology (11.3)</i>].</p>
...
<p>The estimated background risk of major birth defects and miscarriage for the indicated population is unknown. In the U.S. general population, the estimated background risk of major birth defects and miscarriage in clinically recognized pregnancies is 2%&hyphen;4% and 15%&hyphen;20%, respectively.</p>
<p><b>Data</b></p>
<p><u>Animal Data</u></p>
...
<p>IBRANCE capsules for oral administration contain 125 mg, 100 mg, or 75 mg of palbociclib, a kinase inhibitor. The molecular formula for palbociclib is C<sub>24</sub>H<sub>29</sub>N<sub>7</sub>O<sub>2</sub>. The molecular weight is 447.54 daltons. The chemical name is 6&hyphen;acetyl&hyphen;8&hyphen;cyclopentyl&hyphen;5&hyphen;methyl&hyphen;2&hyphen;{[5&hyphen;(piperazin&hyphen;1&hyphen;yl)pyridin&hyphen;2&hyphen;yl]amino}pyrido[2,3&hyphen;<i>d</i>]pyrimidin&hyphen;7(8<i>H</i>)&hyphen;one, and its structural formula is:</p>
<p></p>
<p>Palbociclib is a yellow to orange powder with pKa of 7.4 (the secondary piperazine nitrogen) and 3.9 (the pyridine nitrogen). At or below pH 4, palbociclib behaves as a high&hyphen;solubility compound. Above pH 4, the solubility of the drug substance reduces significantly.</p>
...
<p>Palbociclib is an inhibitor of cyclin&hyphen;dependent kinases (CDK) 4 and 6. Cyclin D1 and CDK4/6 are downstream of signaling pathways which lead to cellular proliferation. <i>In vitro</i>, palbociclib reduced cellular proliferation of estrogen receptor (ER)&hyphen;positive breast cancer cell lines by blocking progression of the cell from G1 into S phase of the cell cycle. Treatment of breast cancer cell lines with the combination of palbociclib and antiestrogens leads to decreased retinoblastoma (Rb) protein phosphorylation resulting in reduced E2F expression and signaling and increased growth arrest compared to treatment with each drug alone. <i>In vitro</i> treatment of ER positive breast cancer cell lines with the combination of palbociclib and antiestrogens led to increased cell senescence compared to each drug alone, which was sustained for up to 6 days following palbociclib removal and was greater if antiestrogen treatment was continued. In vivo studies using a patient derived ER&hyphen;positive breast cancer xenograft model demonstrated that the combination of palbociclib and letrozole increased the inhibition of Rb phosphorylation, downstream signaling, and tumor growth compared to each drug alone. </p>
...
<p><u>Food effect</u>: Palbociclib absorption and exposure were very low in approximately 13% of the population under the fasted condition. Food intake increased the palbociclib exposure in this small subset of the population, but did not alter palbociclib exposure in the rest of the population to a clinically relevant extent. Therefore, food intake reduced the intersubject variability of palbociclib exposure, which supports administration of IBRANCE with food. Compared to IBRANCE given under overnight fasted conditions, the population average area under the concentration&hyphen;time curve from zero to infinity (AUC<SUB>INF</SUB>) and C<sub>max</sub> of palbociclib increased by 21% and 38%, respectively, when given with high&hyphen;fat, high&hyphen;calorie food (approximately 800 to 1000 calories with 150, 250, and 500 to 600 calories from protein, carbohydrate and fat, respectively), by 12% and 27%, respectively, when given with low&hyphen;fat, low&hyphen;calorie food (approximately 400 to 500 calories with 120, 250, and 28 to 35 calories from protein, carbohydrate and fat, respectively), and by 13% and 24%, respectively, when moderate&hyphen;fat, standard calorie food (approximately 500 to 700 calories with 75 to 105, 250 to 350 and 175 to 245 calories from protein, carbohydrate and fat, respectively) was given 1 hour before and 2 hours after IBRANCE dosing. </p>
...
<p>Data from a pharmacokinetic trial in subjects with varying degrees of hepatic impairment indicate that palbociclib unbound AUC<SUB>INF</SUB> decreased 17% in subjects with mild hepatic impairment (Child&hyphen;Pugh class A), and increased by 34% and 77% in subjects with moderate (Child&hyphen;Pugh class B) and severe (Child&hyphen;Pugh class C) hepatic impairment, respectively, relative to subjects with normal hepatic function. Palbociclib unbound C<sub>max</sub> increased by 7%, 38% and 72% for mild, moderate and severe hepatic impairment, respectively, relative to subjects with normal hepatic function. In addition, based on a population pharmacokinetic analysis that included 183 patients, where 40 patients had mild hepatic impairment based on National Cancer Institute (NCI) classification (total bilirubin &leq; ULN and AST > ULN, or total bilirubin >1.0 to 1.5 &times; ULN and any AST), mild hepatic impairment had no effect on the exposure of palbociclib, further supporting the findings from the dedicated hepatic impairment study. </p>

<p><b>Renal Impairment</b></p>

<p>Data from a pharmacokinetic trial in subjects with varying degrees of renal impairment indicate that palbociclib AUC<SUB>INF</SUB> increased by 39%, 42%, and 31% with mild (60 mL/min &leq;CrCl <90 mL/min), moderate (30 mL/min &leq;CrCl <60 mL/min), and severe (CrCl <30 mL/min) renal impairment, respectively, relative to subjects with normal renal function. Peak palbociclib exposure (C<sub>max</sub>) increased by 17%, 12%, and 15% for mild, moderate, and severe renal impairment, respectively, relative to subjects with normal renal function. In addition, based on a population pharmacokinetic analysis that included 183 patients where 73 patients had mild renal impairment and 29 patients had moderate renal impairment, mild and moderate renal impairment had no effect on the exposure of palbociclib. The pharmacokinetics of palbociclib have not been studied in patients requiring hemodialysis. </p>

<p><b>Asian Race</b></p>
<p>In a pharmacokinetic study in healthy volunteers, palbociclib AUC<sub>INF</sub> and C<sub>max</sub> values were 30% and 35% higher, respectively, in Japanese subjects compared with non Asian subjects after a single oral dose. However, this finding was not reproduced consistently in subsequent studies in Japanese or Asian breast cancer patients after multiple dosing. Based on an analysis of the cumulative pharmacokinetic, safety and efficacy data across Asian and non&hyphen;Asian populations, no dose adjustment based on Asian race is considered necessary. </p>

<p><b>Drug Interactions</b></p>

<p><i>In vitro</i>  data indicate that CYP3A and SULT enzyme SULT2A1 are mainly involved in the metabolism of palbociclib. Palbociclib is a weak time&hyphen;dependent inhibitor of CYP3A following daily 125 mg dosing to steady state in humans. <i>In vitro</i>, palbociclib is not an inhibitor of CYP1A2, 2A6, 2B6, 2C8, 2C9, 2C19, and 2D6, and is not an inducer of CYP1A2, 2B6, 2C8, and 3A4 at clinically relevant concentrations. </p>

<p><i>CYP3A Inhibitors:</i>  Data from a drug interaction trial in healthy subjects (N=12) indicate that co&hyphen;administration of multiple 200 mg daily doses of itraconazole with a single 125 mg IBRANCE dose increased palbociclib AUC<SUB>INF</SUB> and the C<sub>max</sub> by approximately 87% and 34%, respectively, relative to a single 125 mg IBRANCE dose given alone [<i>see Drug Interactions (7.1)</i>]. </p>

<p><i>CYP3A Inducers:</i> Data from a drug interaction trial in healthy subjects (N=15) indicate that co&hyphen;administration of multiple 600 mg daily doses of rifampin, a strong CYP3A inducer, with a single 125 mg IBRANCE dose decreased palbociclib AUC<SUB>INF</SUB> and C<sub>max</sub> by 85% and 70%, respectively, relative to a single 125 mg IBRANCE dose given alone. Data from a drug interaction trial in healthy subjects (N=14) indicate that co&hyphen;administration of multiple 400 mg daily doses of modafinil, a moderate CYP3A inducer, with a single 125 mg IBRANCE dose decreased palbociclib AUC<SUB>INF</SUB> and C<sub>max</sub> by 32% and 11%, respectively, relative to a single 125 mg IBRANCE dose given alone [see Drug Interactions (7.2)]. </p>

<p><i>CYP3A Substrates:</i> Palbociclib is a weak time&hyphen;dependent inhibitor of CYP3A following daily 125 mg dosing to steady state in humans. In a drug interaction trial in healthy subjects (N=26), co&hyphen;administration of midazolam with multiple doses of IBRANCE increased the midazolam AUC<SUB>INF</SUB> and the C<sub>max</sub> values by 61% and 37%, respectively, as compared to administration of midazolam alone. [see Drug Interactions (7.3)]. </p>

<p><i>Gastric pH Elevating Medications: </i> In a drug interaction trial in healthy subjects, co&hyphen;administration of a single 125 mg dose of IBRANCE with multiple doses of the proton pump inhibitor (PPI) rabeprazole under fed conditions decreased palbociclib C<sub>max</sub> by 41%, but had limited impact on AUC<SUB>INF</SUB> (13% decrease), when compared to a single dose of IBRANCE administered alone. Given the reduced effect on gastric pH of H2 receptor antagonists and local antacids compared to PPIs, the effect of these classes of acid&hyphen;reducing agents on palbociclib exposure under fed conditions is expected to be minimal. Under fed conditions there is no clinically relevant effect of PPIs, H2&hyphen;receptor antagonists, or local antacids on palbociclib exposure. In another healthy subject study, co&hyphen;administration of a single dose of IBRANCE with multiple doses of the PPI rabeprazole under fasted conditions decreased palbociclib AUC<SUB>INF</SUB> and C<sub>max</sub> by 62% and 80%, respectively, when compared to a single dose of IBRANCE administered alone. </p>

<p><i>Letrozole: </i> Data from a clinical trial in patients with breast cancer showed that there was no drug interaction between palbociclib and letrozole when the 2 drugs were co&hyphen;administered. </p>
...
<p><i>Effect of Palbociclib on Transporters: In vitro</i> evaluations indicated that palbociclib has a low potential to inhibit the activities of drug transporters organic anion transporter (OAT)1, OAT3, organic cation transporter (OCT)2 and organic anion transporting polypeptide (OATP)1B1, OATP1B3 at clinically relevant concentrations. <i>In vitro</i>, palbociclib has the potential to inhibit OCT1 at clinically relevant concentrations, as well as the potential to inhibit P&hyphen;glycoprotein (P&hyphen;gp) or breast cancer resistance protein (BCRP) in the gastrointestinal tract at the proposed dose. </p>

<p><i>Effect of Transporters on Palbociclib:</i> Based on <i>in vitro</i> data, P&hyphen;gp and BCRP mediated transport are unlikely to affect the extent of oral absorption of palbociclib at therapeutic doses. </p>

<p><b>Preclinical safety data</b></p>

<p>The primary target organ findings following single and/or repeat dosing included hematolymphopoietic and male reproductive organ effects in rats and dogs, and effects on bone and actively growing incisors in rats only. These systemic toxicities were generally observed at clinically relevant exposures based on AUC. Partial to full reversal of effects on the hematolymphopoietic, male reproductive systems, and incisor teeth were established, whereas the bone effect was not reversed following a 12&hyphen;week nondosing period. In addition, cardiovascular effects (QTc prolongation, decreased heart rate, and increased RR interval and systolic blood pressure) were identified in telemetered dogs at &ge;4 times human clinical exposure based on C<sub>max</sub>.</p>
...
<p>In a fertility study in female rats, palbociclib did not affect mating or fertility at any dose up to 300 mg/kg/day (approximately 4 times human clinical exposure based on AUC) and no adverse effects were observed in the female reproductive tissues in repeat&hyphen;dose toxicity studies up to 300 mg/kg/day in the rat and 3 mg/kg/day in the dog (approximately 6 times and similar to human exposure [AUC], at the recommended dose, respectively). </p>

<p>The adverse effects of palbociclib on male reproductive function and fertility were observed in the repeat&hyphen;dose toxicology studies in rats and dogs and a male fertility study in rats. In repeat dose toxicology studies, palbociclib related findings in the testis, epididymis, prostate, and seminal vesicle at &ge;30 mg/kg/day in rats and &ge;0.2 mg/kg/day in dogs included decreased organ weight, atrophy or degeneration, hypospermia, intratubular cellular debris, and decreased secretion. Partial reversibility of male reproductive organ effects was observed in the rat and dog following a 4  and 12 week non&hyphen;dosing period, respectively. These doses in rats and dogs resulted in approximately &ge;10 and 0.1 times, respectively, the exposure [AUC] in humans at the recommended dose. In the fertility and early embryonic development study in male rats, palbociclib caused no effects on mating but resulted in a slight decrease in fertility in association with lower sperm motility and density at 100 mg/kg/day with projected exposure levels [AUC] of 20 times the exposure in humans at the recommended dose. </p>
