...
* author = Reference(instance_of_organization) //Add the Instance name for the Organization inside the brackets
...
* section[+]
  ...
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'> 
    ...
    <p>Store in a refrigerator (2&deg;C – 8&deg;C).</p>
    <p>Do not freeze.</p>
